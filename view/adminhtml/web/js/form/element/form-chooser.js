define([
    ...
    return Element.extend({
        ...
        messages: {
            ...
            UNKNOWN_SELECTION: $t('The currently selected form does not exist.')
        },
        defaults: {
            template: 'HappyMachines_CustomFormsPageBuilder/form/element/form-chooser',
        ...
        /**
         * Updates the form data from the server
         *
         * @returns void
         */
        updateFromServer: function () {
            var requestData = $.extend(true, {}, this.requestData);
            // The component hasn't been configured yet. Nothing to do.
